import { A as __toESM, C as require_react, D as stripBasePath, E as hasBasePath, S as AppElementsWire, _ as toBrowserNavigationHref, a as getMountedSlotsHeader, c as prefetchRscResponse, f as createRscRequestHeaders, g as resolveRelativeHref, n as require_jsx_runtime, o as getPrefetchedUrls, p as createRscRequestUrl, r as getCurrentInterceptionContext, s as navigateClientSide, v as toSameOriginAppPath, w as VINEXT_MOUNTED_SLOTS_HEADER, x as isDangerousScheme, y as withBasePath$1 } from "../index.js";
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onMouseEnter, onTouchStart, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-DLLNAfD2.js")).default;
