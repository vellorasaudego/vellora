...
function ContactForm({ turnstileSiteKey = "", turnstileRequired = false }) {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						title: turnstileUnavailable ? "A proteção de segurança está temporariamente indisponível" : turnstilePending ? "Conclua a verificação de segurança para enviar" : void 0,
