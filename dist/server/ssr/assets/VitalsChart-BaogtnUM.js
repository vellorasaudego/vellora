import { A as __toESM, C as require_react, O as __commonJSMin, k as __exportAll, n as require_jsx_runtime, t as require_react_dom } from "../index.js";
...
function roundTemplateLiteral(strings) {
	...
	return strings.reduce((result, string, i) => {
		...
		if (value !== void 0) return result + round$1(value) + string;
...
function interpolate(start, end, animationElapsedTime) {
	if (isNumber(start) && isNumber(end)) return round$1(start + animationElapsedTime * (end - start));
	return end;
}
...
var SizeDetectorContainer = /* @__PURE__ */ (0, import_react.forwardRef)((_ref2, ref) => {
	...
	(0, import_react.useEffect)(() => {
		if (containerRef.current == null || typeof ResizeObserver === "undefined") return noop$3;
...
var objectTraps = {
	...
	set(state, prop, value) {
		...
		if (!state.modified_) {
			...
			if (is$1(value, current2) && (value !== void 0 || has$1(state.base_, prop, state.type_))) return true;
			prepareCopy(state);
			markChanged(state);
		}
		if (state.copy_[prop] === value && (value !== void 0 || has$1(state.copy_, prop, state.type_)) || Number.isNaN(value) && Number.isNaN(state.copy_[prop])) return true;
		state.copy_[prop] = value;
...
}), _tooltipSlice$actions = tooltipSlice.actions, addTooltipEntrySettings = _tooltipSlice$actions.addTooltipEntrySettings, replaceTooltipEntrySettings = _tooltipSlice$actions.replaceTooltipEntrySettings, removeTooltipEntrySettings = _tooltipSlice$actions.removeTooltipEntrySettings, setTooltipSettingsState = _tooltipSlice$actions.setTooltipSettingsState, setActiveMouseOverItemIndex = _tooltipSlice$actions.setActiveMouseOverItemIndex;
...
function useAppSelector(selector) {
	...
	return (0, import_with_selector.useSyncExternalStoreWithSelector)(context ? context.subscription.addNestedSub : addNestedSubNoop, context ? context.store.getState : noop$1, context ? context.store.getState : noop$1, outOfContextSelector, refEquality);
}
//#endregion
...
function getValueByDataKey(obj, dataKey, defaultValue) {
	...
	if (isNumOrStr(dataKey)) return get$1(obj, dataKey, defaultValue);
	...
	if (legendSettings && legendSize) {
		...
		if (position != null) {
			if (isOutsidePosition(position)) {
				if (position === "top" && isNumber(offset.top)) return _objectSpread$35(_objectSpread$35({}, offset), {}, { top: offset.top + (boxHeight || 0) + legendOffset });
				if (position === "bottom" && isNumber(offset.bottom)) return _objectSpread$35(_objectSpread$35({}, offset), {}, { bottom: offset.bottom + (boxHeight || 0) + legendOffset });
				if (position === "left" && isNumber(offset.left)) return _objectSpread$35(_objectSpread$35({}, offset), {}, { left: offset.left + (boxWidth || 0) + legendOffset });
				if (position === "right" && isNumber(offset.right)) return _objectSpread$35(_objectSpread$35({}, offset), {}, { right: offset.right + (boxWidth || 0) + legendOffset });
			}
			return offset;
		}
...
function isWellFormedNumberDomain(v) {
	if (Array.isArray(v) && v.length === 2) {
		var _v = _slicedToArray$19(v, 2), min = _v[0], max = _v[1];
...
function numericalDomainSpecifiedWithoutRequiringData(userDomain, allowDataOverflow) {
	...
	if (Array.isArray(userDomain) && userDomain.length === 2) {
		var _userDomain = _slicedToArray$19(userDomain, 2), providedMin = _userDomain[0], providedMax = _userDomain[1];
...
function parseNumericalUserDomain(userDomain, dataDomain, allowDataOverflow) {
	...
	if (Array.isArray(userDomain) && userDomain.length === 2) {
		var _userDomain2 = _slicedToArray$19(userDomain, 2), providedMin = _userDomain2[0], providedMax = _userDomain2[1];
		var finalMin, finalMax;
		if (providedMin === "auto") {
...
var getValidInterval = (_ref) => {
	var _ref2 = _slicedToArray$18(_ref, 2), min = _ref2[0], max = _ref2[1];
...
var getNiceTickValues = function getNiceTickValues(_ref3) {
	var _ref4 = _slicedToArray$18(_ref3, 2), min = _ref4[0], max = _ref4[1];
	var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var niceTicksMode = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "auto";
	var count = Math.max(tickCount, 2);
	var _getValidInterval2 = _slicedToArray$18(getValidInterval([min, max]), 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
...
var getTickValuesFixedDomain = function getTickValuesFixedDomain(_ref5, tickCount) {
	var _ref6 = _slicedToArray$18(_ref5, 2), min = _ref6[0], max = _ref6[1];
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var niceTicksMode = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "auto";
	var _getValidInterval4 = _slicedToArray$18(getValidInterval([min, max]), 2), cormin = _getValidInterval4[0], cormax = _getValidInterval4[1];
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$33(_objectSpread$33({}, viewBox), {}, {
		radius,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
	...
	return _objectSpread$32(_objectSpread$32({}, implicitAngleAxis), {}, { type: evaluatedType });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
	...
	return _objectSpread$32(_objectSpread$32({}, implicitRadiusAxis), {}, { type: evaluatedType });
});
...
function getErrorDomainByDataKey(entry, appliedValue, relevantErrorBars) {
	...
	return onlyAllowNumbers(relevantErrorBars.flatMap((eb) => {
		...
		if (Array.isArray(errorValue)) {
			var _errorValue = _slicedToArray$17(errorValue, 2);
...
var combineStackGroups = (displayedData, items, stackOffsetType, reverseStackOrder) => {
	...
	return Object.fromEntries(Object.entries(itemsGroup).map((_ref3) => {
		var _ref4 = _slicedToArray$17(_ref3, 2), stackId = _ref4[0], graphicalItems = _ref4[1];
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
	if (axis == null || scale == null) return;
	return _objectSpread$31(_objectSpread$31({}, axis), {}, { scale });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
	...
	if (hasBeenActivePreviously(appropriateMouseInteraction)) {
		if (activeFromProps) return _objectSpread$30(_objectSpread$30({}, appropriateMouseInteraction), {}, { active: true });
	...
	return _objectSpread$30(_objectSpread$30({}, noInteraction), {}, { coordinate: appropriateMouseInteraction.coordinate });
};
//#endregion
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxisDataKey, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref) => {
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			...
			var newSettings = _objectSpread$29(_objectSpread$29({}, settings), {}, {
				name: itemName,
	...
	reducers: {
		...
		updateYAxisWidth(state, action) {
			...
			if (axis) {
				...
				state.yAxis[id] = _objectSpread$27(_objectSpread$27({}, axis), {}, {
					width,
		...
		updateXAxisHeight(state, action) {
			...
			if (axis) {
				...
				state.xAxis[id] = _objectSpread$27(_objectSpread$27({}, axis), {}, {
					height,
...
var rootPropsSlice = createSlice({
	...
	reducers: { updateOptions: (state, action) => {
		...
		state.barGap = (_action$payload$barGa = action.payload.barGap) !== null && _action$payload$barGa !== void 0 ? _action$payload$barGa : initialState$2.barGap;
...
var initialState$1 = { zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current) => _objectSpread$26(_objectSpread$26({}, acc), {}, { [current]: {
	element: void 0,
...
var MainChartSurface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement(Surface, _extends$23({}, otherAttributes, {
		title,
		desc,
		role,
		tabIndex,
...
var RootSurface = /* @__PURE__ */ (0, import_react.forwardRef)((_ref2, ref) => {
	var children = _ref2.children, rest = _objectWithoutProperties$19(_ref2, _excluded$19);
	...
	return /* @__PURE__ */ import_react.createElement(MainChartSurface, _extends$23({ ref }, rest), /* @__PURE__ */ import_react.createElement(AllZIndexPortals, { isPanorama: false }, children));
});
...
function useTooltipSyncEventsListener() {
	...
	(0, import_react.useEffect)(() => {
		if (mySyncId == null) return noop$3;
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, _x = _action$payload$coord.x, _y = _action$payload$coord.y, otherCoordinateProps = _objectWithoutProperties$18(_action$payload$coord, _excluded$18);
...
function useReportScale() {
	var dispatch = useAppDispatch();
	var _useState2 = _slicedToArray$16((0, import_react.useState)(null), 2), ref = _useState2[0], setRef = _useState2[1];
...
var ResponsiveDiv = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	}), /* @__PURE__ */ import_react.createElement("div", _extends$22({ ref: innerRef }, props)));
});
var ReadSizeOnceDiv = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var width = props.width, height = props.height;
	var _useState4 = _slicedToArray$15((0, import_react.useState)({
...
var StaticDiv = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(ReportChartSize, {
		width,
		height
	}), /* @__PURE__ */ import_react.createElement("div", _extends$22({ ref }, props)));
});
var NonResponsiveDiv = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var width = props.width, height = props.height;
	if (typeof width === "string" || typeof height === "string") return /* @__PURE__ */ import_react.createElement(ReadSizeOnceDiv, _extends$22({}, props, { ref }));
	if (typeof width === "number" && typeof height === "number") return /* @__PURE__ */ import_react.createElement(StaticDiv, _extends$22({}, props, {
		width,
		height,
		ref
	}));
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	var containerRef = (0, import_react.useRef)(null);
	var dispatch = useAppDispatch();
	var _useState6 = _slicedToArray$15((0, import_react.useState)(null), 2), tooltipPortal = _useState6[0], setTooltipPortal = _useState6[1];
	var _useState8 = _slicedToArray$15((0, import_react.useState)(null), 2), legendPortal = _useState8[0], setLegendPortal = _useState8[1];
...
var ClipPathProvider = (_ref) => {
	var children = _ref.children;
	var clipPathId = _slicedToArray$14((0, import_react.useState)("".concat(uniqueId("recharts"), "-clip")), 1)[0];
...
var CategoricalChart = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	var attrs = svgPropertiesNoEvents(_objectWithoutProperties$17(props, _excluded$17));
...
function resolveDefaultProps(realProps, defaultProps) {
	var resolvedProps = _objectSpread$23({}, realProps);
	var dp = defaultProps;
...
var defaultCartesianChartProps = _objectSpread$22({
	accessibilityLayer: true,
	barCategoryGap: "10%",
	barGap: 4,
	layout: "horizontal",
...
var CartesianChart = /* @__PURE__ */ (0, import_react.forwardRef)(function CartesianChart(props, ref) {
	...
	}), /* @__PURE__ */ import_react.createElement(CategoricalChart, _extends$21({}, rootChartProps, { ref })));
});
//#endregion
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$21(_objectSpread$21({}, entry), {}, { base: baseLine[index] }));
...
var Curve = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$19({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
*/
function getStrokeDasharray$1(length, totalLength, lines) {
...
function computeAnimatedStrokeDasharray(userStrokeDasharray, totalLength, visibleLength) {
	if (userStrokeDasharray) return getStrokeDasharray$1(visibleLength, totalLength, "".concat(userStrokeDasharray).split(/[,\s]+/gim).map((num) => parseFloat(num)));
...
function LineDrawShape(props) {
	...
	return /* @__PURE__ */ import_react.createElement(Curve, _extends$18({}, curveProps, {
...
function useAnimatedLineLength(points) {
	...
	return (0, import_react.useCallback)((animationElapsedTime, totalLength) => {
		...
		var visibleLength = Math.min(round$1(startingLengthRef.current + animationElapsedTime * totalLength), totalLength);
...
var DecimalCSS = class DecimalCSS {
	static parse(str) {
		...
		var _ref2 = _slicedToArray$13((_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], 3), numStr = _ref2[1], unit = _ref2[2];
...
function calculateArithmetic(expr) {
	...
	while (newExpr.includes("*") || newExpr.includes("/")) {
		...
		var _ref4 = _slicedToArray$13((_MULTIPLY_OR_DIVIDE_R = MULTIPLY_OR_DIVIDE_REGEX.exec(newExpr)) !== null && _MULTIPLY_OR_DIVIDE_R !== void 0 ? _MULTIPLY_OR_DIVIDE_R : [], 4), leftOperand = _ref4[1], operator = _ref4[2], rightOperand = _ref4[3];
	...
	while (newExpr.includes("+") || /.-\d+(?:\.\d+)?/.test(newExpr)) {
		...
		var _ref6 = _slicedToArray$13((_ADD_OR_SUBTRACT_REGE = ADD_OR_SUBTRACT_REGEX.exec(newExpr)) !== null && _ADD_OR_SUBTRACT_REGE !== void 0 ? _ADD_OR_SUBTRACT_REGE : [], 4), _leftOperand = _ref6[1], _operator = _ref6[2], _rightOperand = _ref6[3];
...
function calculateParentheses(expr) {
	...
	while ((match = PARENTHESES_REGEX.exec(newExpr)) != null) {
		var parentheticalExpression = _slicedToArray$13(match, 2)[1];
...
var calculateWordsByLines = (_ref3, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) => {
	...
	while (start <= end && iterations <= text.length - 1) {
		...
		var _checkOverflow2 = _slicedToArray$12(checkOverflow(text, middle - 1, breakAll, style, maxLines, lineWidth, spaceWidth, scaleToFit), 2), doesPrevOverflow = _checkOverflow2[0], result = _checkOverflow2[1];
		var doesMiddleOverflow = _slicedToArray$12(checkOverflow(text, middle, breakAll, style, maxLines, lineWidth, spaceWidth, scaleToFit), 1)[0];
...
var Text = /* @__PURE__ */ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$14(props, _excluded2$8);
...
function LabelList(_ref) {
	var _ref$valueAccessor = _ref.valueAccessor, valueAccessor = _ref$valueAccessor === void 0 ? defaultAccessor : _ref$valueAccessor, restProps = _objectWithoutProperties$12(_ref, _excluded$12), dataKey = restProps.dataKey;
	restProps.clockWise;
	var id = restProps.id, textBreakAll = restProps.textBreakAll, zIndex = restProps.zIndex, others = _objectWithoutProperties$12(restProps, _excluded2$6);
...
function DotItem(_ref) {
	...
	_ref2.points;
	var props = _objectWithoutProperties$11(_ref2, _excluded$11);
...
function Dots(_ref3) {
	...
	var dots = points.map((entry, i) => {
		...
		var dotProps = _objectSpread$18(_objectSpread$18(_objectSpread$18({ r: 3 }, baseProps), customDotProps), {}, {
			index: i,
...
var ActivePoint = (_ref) => {
	...
	var dotProps = _objectSpread$17(_objectSpread$17(_objectSpread$17({}, {
		index: childIndex,
		dataKey,
		cx: point.x,
		cy: point.y,
...
*/
var useIdFallback = () => {
	return _slicedToArray$11(import_react.useState(() => uniqueId("uid-")), 1)[0];
};
...
var RechartsAnimation = class {
	...
	*/
	...
	constructor(param) {
		...
		_defineProperty$17(this, "state", INIT);
...
function JavascriptAnimate(outsideProps) {
	...
	var _useState2 = _slicedToArray$9((0, import_react.useState)(isActive ? from : to), 2), style = _useState2[0], setStyle = _useState2[1];
	(0, import_react.useEffect)(() => {
		if (!isActive) setStyle(to);
	}, [isActive]);
	(0, import_react.useEffect)(() => {
		var easingFunction = createEasingFunction(easing);
		if (!isActive || !canBegin || easingFunction == null) return noop$3;
...
var defaultLineAnimateItems = (items, animationElapsedTime) => {
	...
	var result = [];
	for (var item of items) if (item.status === "matched") result.push(_objectSpread$15(_objectSpread$15({}, item.next), {}, {
		...
		result.push(_objectSpread$15(_objectSpread$15({}, item.next), {}, {
		...
		if (item.prev.x != null) {
			...
			result.push(_objectSpread$15(_objectSpread$15({}, item.prev), {}, {
...
function LineLabelListProvider(_ref3) {
	...
	var labelListEntries = (0, import_react.useMemo)(() => {
		return points === null || points === void 0 ? void 0 : points.map((point) => {
			...
			return _objectSpread$15(_objectSpread$15({}, viewBox), {}, {
				value: point.value,
				payload: point.payload,
				viewBox,
...
function StaticCurve(_ref4) {
	...
	var curveProps = _objectSpread$15(_objectSpread$15({}, svgPropertiesAndEvents(_objectWithoutProperties$9(props, _excluded2$5))), {}, {
		fill: "none",
...
function LineImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(LineWithState, _extends$12({}, everythingElse, {
		id,
		connectNulls,
		dot,
		activeDot,
...
function LineFn(outsideProps) {
	...
	return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
		...
		hide: props.hide,
		isPanorama
	}), /* @__PURE__ */ import_react.createElement(LineImpl, _extends$12({}, props, { id }))));
}
/**
...
function AxisLine(axisLineProps) {
	...
	var props = _objectSpread$13(_objectSpread$13(_objectSpread$13({}, otherSvgProps), svgPropertiesNoEvents(axisLine)), {}, { fill: "none" });
	...
	return /* @__PURE__ */ import_react.createElement("line", _extends$11({}, props, { className: clsx("recharts-cartesian-axis-line", get$1(axisLine, "className")) }));
}
/**
...
function TickItem(props) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) tickItem = /* @__PURE__ */ import_react.cloneElement(option, _objectSpread$13(_objectSpread$13({}, tickProps), {}, { className: combinedClassName }));
	else if (typeof option === "function") tickItem = option(_objectSpread$13(_objectSpread$13({}, tickProps), {}, { className: combinedClassName }));
	else {
...
function RenderedTicksReporter(_ref) {
	...
	(0, import_react.useEffect)(() => {
		if (axisId == null || axisType == null) return noop$3;
		return () => {
...
var Ticks = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	var finalTicks = getTicks(_objectSpread$13(_objectSpread$13({}, getTicksConfig), {}, { ticks }), fontSize, letterSpacing);
	...
	var tickLineProps = _objectSpread$13(_objectSpread$13({}, axisProps), {}, { fill: "none" }, tickLinePropsObject);
	var tickLineCoords = finalTicks.map((entry) => _objectSpread$13({ entry }, getTickLineCoord(entry, x, y, width, height, orientation, tickSize, mirror, tickMargin)));
	var tickLines = tickLineCoords.map((_ref2) => {
		var entry = _ref2.entry, lineCoord = _ref2.line;
		return /* @__PURE__ */ import_react.createElement(Layer, {
			className: "recharts-cartesian-axis-tick",
			key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
		}, tickLine && /* @__PURE__ */ import_react.createElement("line", _extends$11({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", get$1(tickLine, "className")) })));
	});
	var tickLabels = tickLineCoords.map((_ref3, i) => {
		var _ref4, _tickTextProps$angle;
		var entry = _ref3.entry, tickCoord = _ref3.tick;
		var finalTickProps = _objectSpread$13(_objectSpread$13({}, _objectSpread$13(_objectSpread$13(_objectSpread$13(_objectSpread$13({ verticalAnchor }, axisProps), {}, {
			textAnchor,
			stroke: "none",
			fill: stroke
		}, tickCoord), {}, {
...
var CartesianAxisComponent = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	var _useState2 = _slicedToArray$6((0, import_react.useState)(""), 2), fontSize = _useState2[0], setFontSize = _useState2[1];
	var _useState4 = _slicedToArray$6((0, import_react.useState)(""), 2), letterSpacing = _useState4[0], setLetterSpacing = _useState4[1];
...
var _excluded$7 = ["domain", "range"], _excluded2$4 = ["domain", "range"];
...
function axisPropsAreEqual(prevProps, nextProps) {
	...
	var prevDomain = prevProps.domain, prevRange = prevProps.range, prevRest = _objectWithoutProperties$7(prevProps, _excluded$7);
	var nextDomain = nextProps.domain, nextRange = nextProps.range, nextRest = _objectWithoutProperties$7(nextProps, _excluded2$4);
...
function SetXAxisSettings(props) {
	...
	var typeFromProps = props.type, restProps = _objectWithoutProperties$6(props, _excluded$6);
	...
	var settings = (0, import_react.useMemo)(() => {
		...
		return _objectSpread$12(_objectSpread$12({}, restProps), {}, { type: evaluatedType });
...
var XAxisImpl = (props) => {
	...
	props.ticks;
	props.scale;
	var allOtherProps = _objectWithoutProperties$6(props, _excluded2$3);
	synchronizedSettings.id;
	synchronizedSettings.scale;
	var restSynchronizedSettings = _objectWithoutProperties$6(synchronizedSettings, _excluded3$2);
...
var _excluded$5 = ["type"], _excluded2$2 = [
	"dangerouslySetInnerHTML",
	"ticks",
	"scale"
...
function SetYAxisSettings(props) {
	...
	var settings = (0, import_react.useMemo)(() => {
		if (evaluatedType == null) return;
		return _objectSpread$11(_objectSpread$11({}, restProps), {}, { type: evaluatedType });
...
function YAxisImpl(props) {
	...
	props.ticks;
	props.scale;
	var allOtherProps = _objectWithoutProperties$5(props, _excluded2$2);
	synchronizedSettings.id;
	synchronizedSettings.scale;
...
var _excluded$4 = [
	...
	"y2",
	"key"
], _excluded2$1 = ["offset"], _excluded3 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) lineItem = /* @__PURE__ */ import_react.cloneElement(option, lineItemProps);
		...
		var x1 = lineItemProps.x1, y1 = lineItemProps.y1, x2 = lineItemProps.x2, y2 = lineItemProps.y2, key = lineItemProps.key, _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$4(lineItemProps, _excluded$4))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {};
		_ref2.offset;
		var restOfFilteredProps = _objectWithoutProperties$4(_ref2, _excluded2$1);
...
function HorizontalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$4(props, _excluded3);
	var items = horizontalPoints.map((entry, i) => {
		var lineItemProps = _objectSpread$10(_objectSpread$10({}, otherLineItemProps), {}, {
			x1: x,
			y1: entry,
			x2: x + width,
			y2: entry,
...
var defaultVerticalCoordinatesGenerator = (_ref3, syncWithTicks) => {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$10(_objectSpread$10(_objectSpread$10({}, defaultCartesianAxisProps), xAxis), {}, {
...
var defaultHorizontalCoordinatesGenerator = (_ref4, syncWithTicks) => {
	...
	return getCoordinatesOfGrid(getTicks(_objectSpread$10(_objectSpread$10(_objectSpread$10({}, defaultCartesianAxisProps), yAxis), {}, {
...
function CartesianGrid(props) {
	...
	var propsIncludingDefaults = _objectSpread$10(_objectSpread$10({}, resolveDefaultProps(props, defaultCartesianGridProps)), {}, {
...
var DefaultTooltipContent = (props) => {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				if (finalFormatter) {
					...
					if (Array.isArray(formatted)) {
						var _formatted = _slicedToArray$5(formatted, 2);
						finalValue = _formatted[0];
						finalName = _formatted[1];
					} else if (formatted != null) finalValue = formatted;
					else return null;
				}
				var finalItemStyle = _objectSpread$9(_objectSpread$9({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalLabelStyle = _objectSpread$9({ margin: 0 }, labelStyle);
	...
	return /* @__PURE__ */ import_react.createElement("div", _extends$7({
		className: wrapperCN,
		style: finalStyle
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$8(_objectSpread$8({}, props.hasPortalFromProps ? {} : _objectSpread$8(_objectSpread$8({ transition: resolveTransitionProperty({
...
function useElementOffset() {
	...
	var _useState2 = _slicedToArray$3((0, import_react.useState)({
		height: 0,
		left: 0,
		top: 0,
		width: 0
...
var Cross = (_ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$6({}, svgPropertiesAndEvents(props), {
...
*/
var _excluded$2 = ["radius"], _excluded2 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		...
		var otherPathProps = _objectWithoutProperties$2(_svgPropertiesAndEven, _excluded$2);
		return /* @__PURE__ */ import_react.createElement("path", _extends$5({}, otherPathProps, {
			x: round$1(x),
			y: round$1(y),
			width: round$1(width),
	...
	return /* @__PURE__ */ import_react.createElement(JavascriptAnimate, {
		...
		var otherPathProps = _objectWithoutProperties$2(_svgPropertiesAndEven2, _excluded2);
		return /* @__PURE__ */ import_react.createElement("path", _extends$5({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
...
var Sector = (sectorProps) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$4({}, svgPropertiesAndEvents(props), {
		className: layerClass,
		d: path
	}));
};
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$5(_objectSpread$5({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
//#endregion
...
function Cursor(props) {
	...
	return /* @__PURE__ */ import_react.createElement(CursorInternal, _extends$3({}, props, {
		offset,
		layout,
		tooltipAxisBandSize,
		chartName
...
function Tooltip(outsideProps) {
	...
	var _useElementOffset2 = _slicedToArray$1(useElementOffset([payload, finalIsActive]), 2), lastBoundingBox = _useElementOffset2[0], updateBoundingBox = _useElementOffset2[1];
	...
	if (filterNull && finalPayload.length) finalPayload = getUniqPayload(finalPayload.filter((entry) => entry.value != null && (entry.hide !== true || props.includeHidden)), payloadUniqBy, defaultUniqBy$1);
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$2(_objectSpread$2({}, _objectWithoutProperties$1(_ref, _excluded$1)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /* @__PURE__ */ import_react.createElement("path", _extends$2({}, filteredProps, {
...
function Items(props) {
	...
	return payload.map((entry, i) => {
		...
		var finalLabelStyle = typeof labelStyle === "object" ? _objectSpread$1({}, labelStyle) : {};
		...
		return /* @__PURE__ */ import_react.createElement("li", _extends$1({
			className,
			style: itemStyle,
...
var DefaultLegendContent = (outsideProps) => {
	...
	return /* @__PURE__ */ import_react.createElement("ul", {
		...
		style: finalStyle
	}, /* @__PURE__ */ import_react.createElement(Items, _extends$1({}, props, { payload })));
};
//#endregion
...
function LegendImpl(outsideProps) {
	...
	var _useElementOffset2 = _slicedToArray(useElementOffset([contextPayload]), 2), lastBoundingBox = _useElementOffset2[0], updateBoundingBox = _useElementOffset2[1];
	var chartWidth = useChartWidth();
	var chartHeight = useChartHeight();
	...
	return /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react.createElement("div", {
		...
		position: props.position,
		offset: props.offset
	}), shouldReportDimensions && /* @__PURE__ */ import_react.createElement(LegendSizeDispatcher, lastBoundingBox), /* @__PURE__ */ import_react.createElement(LegendContent, _extends({}, props, { layout }, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
...
function SingleMetricChart({ data, dataKey, title, unit, domain }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartFrame, {
		title,
		unit,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResponsiveContainer, {
...
function HeartRateChart({ data }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SingleMetricChart, {
		data,
		dataKey: "heart_rate",
...
//#endregion
export { BloodPressureChart, GlucoseChart, HeartRateChart, Spo2Chart, TemperatureChart };
