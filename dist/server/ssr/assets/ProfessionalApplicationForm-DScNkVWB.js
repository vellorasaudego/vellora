...
import { t as TurnstileWidget } from "./TurnstileWidget-BueiZ1JH.js";
...
function ProfessionalApplicationForm({ turnstileSiteKey = "", turnstileRequired = false }) {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						title: !lgpdAuthorized ? "Autorize o uso dos dados para enviar a solicitação" : turnstileUnavailable ? "A proteção de segurança está temporariamente indisponível" : turnstilePending ? "Conclua a verificação de segurança para enviar" : void 0,
					...
					turnstileUnavailable ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-xs font-medium text-[var(--status-critical)]",
						role: "status",
						children: "O envio ficará disponível quando a proteção de segurança for configurada."
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
