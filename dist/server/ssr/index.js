...
var client_references_default = {
	...
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BdfQGID3.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"1b3fb4a67ee2": async () => {
		const m = await import("./assets/AssignmentsManager-CKZboqZ5.js");
		return { get "AssignmentsManager"() {
			return m["AssignmentsManager"];
		} };
	},
	"41efcf7ef052": async () => {
		const m = await import("./assets/EditPatientForm-s8XxufH2.js");
		return { get "EditPatientForm"() {
			return m["EditPatientForm"];
		} };
	},
	"525ea88c7dc9": async () => {
		const m = await import("./assets/LogoutButton-a2PSxZlD.js");
		return { get "LogoutButton"() {
			return m["LogoutButton"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-B7CxZhNQ.js");
		return {
			get "ErrorBoundary"() {
	...
	"59ccb47cf7ae": async () => {
		const m = await import("./assets/CaregiverBank-C4dk2W0l.js");
		return { get "CaregiverBank"() {
			return m["CaregiverBank"];
		} };
	},
	"89609f94f48b": async () => {
		const m = await import("./assets/NewCaregiverForm-DkmfGi2W.js");
		return { get "NewCaregiverForm"() {
			return m["NewCaregiverForm"];
		} };
	},
	"8b554f06f596": async () => {
		const m = await import("./assets/NewPatientForm-CGdGf2J9.js");
		return { get "NewPatientForm"() {
			return m["NewPatientForm"];
		} };
	},
	"8c0f216c4604": async () => {
	...
	"a832555ecba8": async () => {
		const m = await import("./assets/DeleteButton-D2qeWxlx.js");
		return { get "DeleteButton"() {
			return m["DeleteButton"];
		} };
	},
	"adcf62948e95": async () => {
		const m = await import("./assets/ProfessionalApplicationsTable-BkjMBlhH.js");
		return { get "ProfessionalApplicationsTable"() {
			return m["ProfessionalApplicationsTable"];
		} };
	},
	"b67ba796ee67": async () => {
	...
	"b848232df12e": async () => {
		const m = await import("./assets/ContractManager-BFueNZHD.js");
		return { get "ContractManager"() {
			return m["ContractManager"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-H0xyTzG3.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"ee11ef59f376": async () => {
		const m = await import("./assets/LoginForm--Ra9R-4t.js");
		return { get "LoginForm"() {
			return m["LoginForm"];
		} };
	},
	"f16d7dcb5c6b": async () => {
		const m = await import("./assets/VitalsChart-BaogtnUM.js");
		return {
			get "BloodPressureChart"() {
				return m["BloodPressureChart"];
			},
			get "GlucoseChart"() {
				return m["GlucoseChart"];
			},
			get "HeartRateChart"() {
				return m["HeartRateChart"];
			},
			get "Spo2Chart"() {
				return m["Spo2Chart"];
			},
			get "TemperatureChart"() {
				return m["TemperatureChart"];
			}
		};
	},
	"f88a42f885ab": async () => {
		const m = await import("./assets/LeadsTable-Crv73-mM.js");
		return { get "LeadsTable"() {
			return m["LeadsTable"];
		} };
	}
};
...
//#endregion
export { __toESM as A, require_react as C, stripBasePath as D, hasBasePath as E, __commonJSMin as O, AppElementsWire as S, VINEXT_PARAMS_HEADER as T, toBrowserNavigationHref as _, getMountedSlotsHeader as a, assertSafeNavigationUrl as b, prefetchRscResponse as c, ReadonlyURLSearchParams as d, app_ssr_entry_default as default, createRscRequestHeaders as f, resolveRelativeHref as g, isHashOnlyBrowserUrlChange as h, handleSsr, getLayoutSegmentContext as i, __exportAll as k, usePathname as l, notifyAppRouterTransitionStart as m, require_jsx_runtime as n, getPrefetchedUrls as o, createRscRequestUrl as p, getCurrentInterceptionContext as r, navigateClientSide as s, require_react_dom as t, useRouter as u, toSameOriginAppPath as v, VINEXT_MOUNTED_SLOTS_HEADER as w, isDangerousScheme as x, withBasePath as y };
